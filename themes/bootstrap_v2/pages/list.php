<?php
	...
	*/
	...
	if (!empty($_SESSION[$menu['table'].'_search_value']) || !empty($_SESSION[$menu['table'].'_search_value_support']) || !empty($_SESSION[$menu['table'].'_search_value_edition']) || !empty($_SESSION[$menu['table'].'_search_value_filmvu']) || !empty($_SESSION[$menu['table'].'_search_value_genre']) || !empty($_SESSION[$menu['table'].'_search_value_annee']))
	{
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<div class="row">
				...
				<?php if ($menu['type'] == 'jeuxvideo' || $menu['type'] == 'musique' || $menu['type'] == 'video') { ?>
					<div class="col-xs-12 <?php if ($menu['type'] == 'video') echo 'col-sm-3 col-md-2'; else echo 'col-sm-4 col-md-4' ?>">
						<div class="form-group">
				...
				<?php if ($menu['type'] == 'video') { ?>
					<div class="col-xs-12 col-sm-3 col-md-2">
						<div class="form-group">
							...
							<form method="POST" action="?op=list&table=<?php echo $table; ?>">
								<div class="input-group">
									<select class="form-control select2-edition" name="<?php echo $menu['table']; ?>_search_value_edition" onchange="this.form.submit()" style="width:100%;">
										<option></option>
										<?php
											foreach ($list_edition as $key => $value1)
											{
												if ($_SESSION[$menu['table'].'_search_value_edition'] == $value1) $nfselect = 'selected'; else $nfselect = '';
												echo '<option value="'.$value1.'" '.$nfselect.'>'.$value1.'</option>';
											}
										?>
									</select>
									<?php if (!empty($_SESSION[$menu['table'].'_search_value_edition'])) { ?>
										<div class="input-group-btn"><button type="submit" class="btn btn-primary" name="<?php echo $menu['table']; ?>_search_value_edition" value=""><i class="fa fa-close"></i></button></div>
									<?php } ?>
								</div>
							</form>
						</div>
				...
				<?php } ?>
				<div class="col-xs-12 <?php if ($menu['type'] == 'jeuxvideo' || $menu['type'] == 'musique') echo 'col-sm-4 col-md-4'; elseif ($menu['type'] == 'video') echo 'col-sm-3 col-md-2'; else echo 'col-sm-6 col-md-6' ?>">
					<div class="form-group">
