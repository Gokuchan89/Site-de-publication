<?php
	...
	*/
	...
	if ($_SESSION[$menu['table'].'_search_value'] != '' || $_SESSION[$menu['table'].'_search_value_support'] != '' || $_SESSION[$menu['table'].'_search_value_edition'] != '' || $_SESSION[$menu['table'].'_search_value_filmvu'] != '' || $_SESSION[$menu['table'].'_search_value_genre'] != '' || $_SESSION[$menu['table'].'_search_value_annee'] != '')
	{
		...
		if ($_SESSION[$menu['table'].'_search_value_edition'] != '') $list_search .= ' AND `Edition` = "'.$_SESSION[$menu['table'].'_search_value_edition'].'"';
						...
						<div class="form-group">
							...
							<form method="POST" action="?op=list&table=<?php echo $table; ?>">
								<div class="input-group">
									...
									<?php if($_SESSION[$menu['table'].'_search_value_edition'] != '') { ?>
										<div class="input-group-btn">
											<button type="submit" class="btn btn-primary" name="<?php echo $menu['table']; ?>_search_value_edition" value=""><i class="fa fa-close"></i></button>
										</div>
									<?php } ?>
								</div>
							</form>
