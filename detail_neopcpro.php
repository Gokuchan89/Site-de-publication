		...
		<div class="panel">
			...
			<?php if($menu['type'] == 'video') { ?>
				...
				<script>
					...
					{
						// Lance le popup
						window.open(adresse, '', 'width=1200px, height=auto, left=100, top=100, scrollbars=no, resizable=no, location=no, menubar=no, status=no, toolbar=no, menubar=no,toolbar=no, dependent=no');
					}
				</script>
				<li class="list-group-item text-center">
					<a href="<?php echo $detail['MediaChemin']; ?>" class="btn btn-info" rel="tooltip" title="Téléchargement (fenêtre pop-up)" onclick="javascript:popup(this.href); return false;"><i class="fa fa-download"></i> Téléchargement</a>
				</li>
			<?php } ?>
		</div>
	</div>
