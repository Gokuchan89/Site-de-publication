<head>
	...
	<!-- JQUERY THEME -->
	<link rel="stylesheet" href="./template/bootstrap/css/jquery-themes/black-tie/jquery-ui.min.css">
	<!-- FONT-AWESOME 4.6.1 -->
	...
	<!-- SELECT2 BOOTSTRAP THEME 0.1.0 bêta 4 -->
	...
	<!-- BXSLIDER 4.2.5 -->
	<link rel="stylesheet" href="./template/bootstrap/plugins/bxslider/css/bxslider.min.css">
</head>